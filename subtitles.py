...
prefs = {"download.default_directory" : "</home/pleasework/Downloads", "download.prompt_for_download": False}
...
try:
    ...
    disagree_button = consent_banner.find_element(By.XPATH, '//*[@id="W0wltc"]/div')
...
wait.until(EC.presence_of_element_located((By.CSS_SELECTOR, "li.subtitleContainer")))
...
#----------------filtering subtitles----------------
    ...
    subtitle_year = subtitle.find_element(By.XPATH, ".//h3/i").text[1:5]    #remove ()
...
for redirect_link in redirect_links:
    ...
    #find download link
    download_link = wait.until(EC.presence_of_element_located((By.XPATH, "//div[@class='bottom']//a[contains(@href, '/download/?type=1&mediaid=')]"))).click()
